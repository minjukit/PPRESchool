...
public class TestDone extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveScore(new ScoreData(id,String.valueOf(testScore),"")); //날짜는 서버에서
    ...
    //db 저장위한 레트로핏 통신
    private void saveScore(ScoreData data) {
        service.saveScore(data).enqueue(new Callback<JoinResponse>() {
