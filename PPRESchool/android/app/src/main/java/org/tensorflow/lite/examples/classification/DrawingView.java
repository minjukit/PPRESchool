...
import org.tensorflow.lite.examples.classification.StrokeManager.ContentChangedListener;
...
public class DrawingView extends View implements ContentChangedListener {
    ...
    public DrawingView(Context context, AttributeSet attributeSet) {
        ...
        currentStrokePaint.setColor(Color.parseColor("#2e2e2e")); // 펜 색깔
    ...
    */
    ...
    @Override
    public boolean onTouchEvent(MotionEvent event) { //실제로 그리는 코드
