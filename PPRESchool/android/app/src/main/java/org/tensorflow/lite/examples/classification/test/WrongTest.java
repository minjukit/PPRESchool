...
public class WrongTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        current_sc = findViewById(R.id.current_score_w);
        ...
        getWrongTest(0); //처음 한번만 gettest 호출
    ...
    public void check(View v){
        ...
        if(record == 11){
            Intent intent = new Intent(getApplicationContext(), WTestDone.class);
    ...
    private void getWrongTest(int i) {
        String id = ((LoginActivty) LoginActivty.login_con).id;
        Call<List<VocaData>> call = service.getWrongTest(new VocaData(id));
        ...
        call.enqueue(new Callback<List<VocaData>>()
        {
            ...
            public void onFailure(Call<List<VocaData>> call, Throwable t) {
                Toast.makeText(WrongTest.this, "테스트 조회 서버 에러 발생", Toast.LENGTH_SHORT).show();
